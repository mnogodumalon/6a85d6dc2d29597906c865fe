  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'gesundheitshinweise': (
      <div key="gesundheitshinweise" className="space-y-1.5">
        <Label htmlFor="gesundheitshinweise">{fieldLabel('hunde', 'gesundheitshinweise')}</Label>
        <Textarea
          id="gesundheitshinweise"
          placeholder="Allergien, Medikamente, Verhaltensbesonderheiten..."
    ...
    'tierarzt': (
      <div key="tierarzt" className="space-y-1.5">
        <Label htmlFor="tierarzt">{fieldLabel('hunde', 'tierarzt')}</Label>
        <Input
          id="tierarzt"
          placeholder="z. B. Dr. Schmidt, 030 1234567"
          value={fields.tierarzt ?? ''}
          onChange={e => setFields(f => ({ ...f, tierarzt: e.target.value }))}
        />
      </div>
    ),
    'besitzer': (
