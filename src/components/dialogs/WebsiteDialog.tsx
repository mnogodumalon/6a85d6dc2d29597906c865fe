...
export function WebsiteDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: WebsiteDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "unternehmensname": string | null, // Name der Pension\n  "slogan": string | null, // Slogan\n  "beschreibung": string | null, // Beschreibungstext\n  "anzahl_plaetze": number | null, // Anzahl der Plätze\n  "leistungen": string | null, // Unsere Leistungen\n  "usps": string | null, // Besondere Merkmale / Alleinstellungsmerkmale\n  "oeffnungszeiten": string | null, // Öffnungszeiten\n  "kontakt_telefon": string | null, // Telefon\n  "kontakt_email": string | null, // E-Mail\n  "website_url": string | null, // Website-Adresse\n  "kontakt_strasse": string | null, // Straße\n  "kontakt_hausnummer": string | null, // Hausnummer\n  "kontakt_plz": string | null, // Postleitzahl\n  "kontakt_ort": string | null, // Ort\n}`;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. 'Dein Hund ist bei uns zu Hause'"
          value={fields.slogan ?? ''}
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile (z. B. 'Tägliche Spaziergänge', 'Trainingsbetreuung'...)"
    ...
    'usps': (
      <div key="usps" className="space-y-1.5">
        <Label htmlFor="usps">{fieldLabel('website', 'usps')}</Label>
        <Textarea
          id="usps"
          placeholder="Besonderheiten, die uns unterscheiden (eine pro Zeile)..."
          value={fields.usps ?? ''}
          onChange={e => setFields(f => ({ ...f, usps: e.target.value }))}
          rows={3}
        />
      </div>
    ),
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Eine Zeile pro Tag (z. B. 'Mo–Fr: 08:00–18:00, Sa 10:00–14:00')..."
    ...
    'kontakt_telefon': (
      <div key="kontakt_telefon" className="space-y-1.5">
        <Label htmlFor="kontakt_telefon">{fieldLabel('website', 'kontakt_telefon')}</Label>
        <Input
          id="kontakt_telefon"
    ...
    'kontakt_email': (
      <div key="kontakt_email" className="space-y-1.5">
        <Label htmlFor="kontakt_email">{fieldLabel('website', 'kontakt_email')}</Label>
        <Input
          id="kontakt_email"
          type="email"
    ...
    'kontakt_strasse': (
      <div key="kontakt_strasse" className="space-y-1.5">
        <Label htmlFor="kontakt_strasse">{fieldLabel('website', 'kontakt_strasse')}</Label>
        <Input
          id="kontakt_strasse"
          placeholder="z. B. Hundestraße"
          value={fields.kontakt_strasse ?? ''}
          onChange={e => setFields(f => ({ ...f, kontakt_strasse: e.target.value }))}
        />
      </div>
    ),
    'kontakt_hausnummer': (
      <div key="kontakt_hausnummer" className="space-y-1.5">
        <Label htmlFor="kontakt_hausnummer">{fieldLabel('website', 'kontakt_hausnummer')}</Label>
        <Input
          id="kontakt_hausnummer"
          placeholder="z. B. 99"
          value={fields.kontakt_hausnummer ?? ''}
          onChange={e => setFields(f => ({ ...f, kontakt_hausnummer: e.target.value }))}
        />
      </div>
    ),
    'kontakt_plz': (
      <div key="kontakt_plz" className="space-y-1.5">
        <Label htmlFor="kontakt_plz">{fieldLabel('website', 'kontakt_plz')}</Label>
        <Input
          id="kontakt_plz"
          placeholder="z. B. 10115"
          value={fields.kontakt_plz ?? ''}
          onChange={e => setFields(f => ({ ...f, kontakt_plz: e.target.value }))}
        />
      </div>
    ),
    'kontakt_ort': (
      <div key="kontakt_ort" className="space-y-1.5">
        <Label htmlFor="kontakt_ort">{fieldLabel('website', 'kontakt_ort')}</Label>
        <Input
          id="kontakt_ort"
          placeholder="z. B. Berlin"
          value={fields.kontakt_ort ?? ''}
          onChange={e => setFields(f => ({ ...f, kontakt_ort: e.target.value }))}
        />
      </div>
    ),
  };
  ...
  const FIELD_LABELS: Record<string, string> = {"unternehmensname": "Name der Pension", "slogan": "Slogan", "beschreibung": "Beschreibungstext", "anzahl_plaetze": "Anzahl der Plätze", "logo": "Logo / Titelbild", "leistungen": "Unsere Leistungen", "usps": "Besondere Merkmale / Alleinstellungsmerkmale", "oeffnungszeiten": "Öffnungszeiten", "kontakt_telefon": "Telefon", "kontakt_email": "E-Mail", "website_url": "Website-Adresse", "kontakt_strasse": "Straße", "kontakt_hausnummer": "Hausnummer", "kontakt_plz": "Postleitzahl", "kontakt_ort": "Ort"};
