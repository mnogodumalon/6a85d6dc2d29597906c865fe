        ...
        <Table className="[&_tbody_td]:px-6 [&_tbody_td]:py-2 [&_tbody_td]:text-base [&_tbody_td]:font-medium [&_tbody_tr:first-child_td]:pt-6 [&_tbody_tr:last-child_td]:pb-10">
          <TableHeader className="bg-secondary">
            <TableRow className="border-b border-input">
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('usps')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'usps')}
                  {sortKey === 'usps' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('kontakt_telefon')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'kontakt_telefon')}
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('kontakt_email')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'kontakt_email')}
              ...
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('kontakt_strasse')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'kontakt_strasse')}
                  {sortKey === 'kontakt_strasse' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('kontakt_hausnummer')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'kontakt_hausnummer')}
                  {sortKey === 'kontakt_hausnummer' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('kontakt_plz')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'kontakt_plz')}
                  {sortKey === 'kontakt_plz' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
              <TableHead className="uppercase text-xs font-semibold text-secondary-foreground tracking-wider px-6 cursor-pointer select-none hover:text-foreground transition-colors" onClick={() => toggleSort('kontakt_ort')}>
                <span className="inline-flex items-center gap-1">
                  {fieldLabel('website', 'kontakt_ort')}
                  {sortKey === 'kontakt_ort' ? (sortDir === 'asc' ? <IconArrowUp size={14} /> : <IconArrowDown size={14} />) : <IconArrowsUpDown size={14} className="opacity-30" />}
                </span>
              </TableHead>
          ...
          <TableBody>
            {sortRecords(filtered).map(record => (
              <TableRow key={record.record_id} className="hover:bg-muted/50 transition-colors cursor-pointer" onClick={(e) => { if ((e.target as HTMLElement).closest('button, [role="checkbox"]')) return; navigate(`/website/${record.record_id}`); }}>
                ...
                <TableCell className="max-w-xs"><span className="truncate block">{record.fields.usps ?? '—'}</span></TableCell>
                ...
                <TableCell>{record.fields.kontakt_strasse ?? '—'}</TableCell>
                <TableCell>{record.fields.kontakt_hausnummer ?? '—'}</TableCell>
                <TableCell>{record.fields.kontakt_plz ?? '—'}</TableCell>
                <TableCell>{record.fields.kontakt_ort ?? '—'}</TableCell>
                <TableCell>
